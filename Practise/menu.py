...
def wamburger():
    while True:
        ...
        while True:
            #ask user for item
            added = input("what do you want to add to your order:  ").lower().strip()
            ...
            end = input("is this all(y/n):  ").lower().strip()
            if end == "y" or end == "yes":
                #if they are, quit
                break
            else:
        ...
        tip = input("please select a tip of $0, $5, $15, or custom:  ").strip()
        cost += int(tip)
